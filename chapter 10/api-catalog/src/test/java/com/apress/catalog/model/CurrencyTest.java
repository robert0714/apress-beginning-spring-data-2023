...
public class CurrencyTest {
    ...
    public void testCurrencyConstructorAndGetters() {
        ...
        Currency currency = new Currency(  code, description, enabled, decimalPlaces, symbol);
...
//        assertEquals(newId, currency.getId());
    ...
    public void testCurrencyEqualsAndHashCode() {
        Currency currency1 = new Currency(  "USD", "Dollar", true, 2, "$");
        Currency currency2 = new Currency(  "USD", "Dollar", true, 2, "$");
        Currency currency3 = new Currency(  "EUR", "Euro", false, 3, "€");
