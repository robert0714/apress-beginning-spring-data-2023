...
public class StateDTOTest {
    ...
    public void testStateDTOConstructorAndGetters() { 
        ...
        CountryDTO countryDTO = new CountryDTO(UUID.randomUUID(), "US", "United States", "en_US", "America/New_York", true, currency);
    ...
    public void testStateDTOEqualsAndHashCode() {
    	CurrencyDTO currency = new CurrencyDTO();
        CountryDTO countryDTO1 = new CountryDTO(UUID.randomUUID(), "US", "United States", "en_US", "America/New_York", true, currency);
        CountryDTO countryDTO2 = new CountryDTO(UUID.randomUUID(), "CA", "Canada", "ca_CAN", "Canada/Yukon", true, currency);
