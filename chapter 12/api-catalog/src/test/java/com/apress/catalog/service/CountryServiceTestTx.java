...
import com.apress.catalog.TestPostgresApplication;
...
//                   "spring.datasource.url=jdbc:tc:postgresql:15.6:///spring_data",
                   "spring.sql.init.platform=postgresql",
                   "spring.flyway.enabled=false"
        })
//@TestPropertySource(properties = "debug=true")
@Import(value= { TestPostgresApplication.class, })
public class CountryServiceTestTx {  
	@Autowired
